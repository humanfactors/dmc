...
# Excellent updating
plot.dmc(samples2,p.prior=p.prior,show.obs=FALSE)
...
### Extension 1: Automatic sampling
...
# parameterization as here but just one more (sd_v) paramerer estiamted and show 
