...
*Note*: Before running these scripts, the current working directory must be set to the top-level folder containing the
dmc and tutorial subfolders
...
(1) Once a model is created you can view these names (assuming you called the model "model") using `attr(model,"p.vector")`
