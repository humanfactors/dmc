...
# This makes Figure 2a, which combines the priors for the population means (locations) 
...
# This makes the prior and posterior plots in Figure 2b and c
...
ggplot.RP.dmc(pp,include.NR=TRUE)  # Figure 4a
...
# it has no RT data.
ggplot.RT.dmc(pp) # Figure 4b

# Plot average cdf (Figure 4c)
...
# Here we use 12 percentile intervals. This is used to create Figure 5a. Note the 
...
# This is used to create Figure 5b
par(mfrow=c(1,1))
